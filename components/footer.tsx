      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 border-b border-gray-700 pb-10">
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="tel:+919899943137" className="hover:underline">+91 9899943137</a></li>
              <li><a href="tel:+918851361171" className="hover:underline">+91-8851361171</a></li>
            </ul>
          </div>
          {/* Write */}
          <div className="md:col-span-1">
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="mailto:info@sculptdesignstudio.com" className="hover:underline">info@sculptdesignstudio.com</a></li>
            </ul>
          </div>
          {/* Visit */}
          <div className="md:col-span-1">
            ...
            <ul className="space-y-2 text-sm">
              <li>A – 9, Basement Floor, Lok Vihar,</li>
              <li>Pitam Pura, New Delhi, Delhi 110034</li>
            </ul>
          </div>
          {/* Logo & Description */}
